    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          style={{ borderColor: 'var(--teal-soft)', '--tw-ring-color': 'var(--teal-primary)' } as React.CSSProperties}
        />
      </div>
      <div>
      ...
      <div className="relative my-4">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t" style={{ borderColor: 'var(--teal-soft)' }} />
        </div>
        <div className="relative flex justify-center text-xs" style={{ color: 'var(--stone)' }}>
      ...
      <button
        ...
        className="w-full py-2.5 rounded-lg font-medium text-sm border flex items-center justify-center gap-2"
        style={{ borderColor: 'var(--teal-soft)', color: 'var(--ink)' }}
      >
